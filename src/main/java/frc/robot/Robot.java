...
public class Robot extends TimedRobot {
    ...
    JoystickButton manipulatorTrigger = new JoystickButton(manipulatorStick, 0);
    JoystickButton manipulatorButton = new JoystickButton(manipulatorStick, 1);
    ...
    public void teleopPeriodic() {
        ...
        if (manipulatorTrigger.get()) {
            intake.setIntake();
        } else {
            intake.stopIntake();
        }

        if (manipulatorButton.get()) {
            gate.setGateOpen();
        } else {
            gate.setGateClosed();
        }
